...
public class PropsUI extends Props {
     ...
     * @param sourceRepository True if the file was loaded from repository, false if ld is an
     *                         XML file.
     * @param repositoryName   The name of the repository the file was loaded from or save
     *                         to.
     */
