...
import org.kettle.ext.task.MybatisDaoSuppo;
import org.kettle.ext.utils.ExceptionUtils;
...
//				}
            ...
            trace.setEndTime(new Date());
            session.insert("org.kettle.sxdata.dao.ExecutionTraceDao.addExecutionTrace", trace);
            session.commit();
            session.close();
        }
    }
