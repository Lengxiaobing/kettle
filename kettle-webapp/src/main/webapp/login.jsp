        ...
        <form id="main" action="<%=basePath%>ns1/user_login.action" method="post">
            <table class="lui_login_form_table">
                ...
                <tr>
                    ...
                    <td class="lui_login_input_td">
                        <div class="lui_login_input_div">
                            <input class="lui_login_input_username" style="" type="text" name="username" id="username"
                                   value=""/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="lui_login_input_td">
                        <div class="lui_login_input_div">
                            <input class="lui_login_input_password" type="password" name="password" id="password"
                                   value=""/>
                        </div>
                    </td>
                </tr>
            ...
            <input type="button" style="border: 0px; width: 0px; height: 0px; background: none;" name="btn_submit"
                   onclick="login()">
        </form>
    </div>
</div>
