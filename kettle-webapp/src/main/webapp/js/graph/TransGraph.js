...
//			});
        ...
        if (this.Executable == false && this.readOnly == false) {
            this.tbar = [{
                ...
                iconCls: 'ClusterSchema', scope: this, handler: this.clusterSchema, tooltip:'集群架构'
            }, {
                iconCls: 'PartitionSchema', scope: this, handler: this.partitionSchema, tooltip:'分区架构'
            }, '-', {
                ...
                iconCls: 'show-results', scope: this, handler: this.showHoopCluster, tooltip: 'Hoop Cluster'
            }];
    ...
    initContextMenu: function (menu, cell, evt) {
        ...
        if (this.Executable == false && this.readOnly == false) {
            if (cell == null) {
                ...
                menu.addItem('从剪贴板粘贴步骤', null, function () {
                    alert(1);
                }, null, null, true);
                menu.addSeparator(null);
                menu.addItem('全选', null, function () {
                    me.getGraph().selectVertices();
                }, null, null, true);
                menu.addItem('清除选择', null, function () {
                    me.getGraph().clearSelection();
                }, null, null, true);
                menu.addSeparator(null);
                ...
                if (cell.value.nodeName == 'NotePad') {
                    ...
                    menu.addItem('编辑步骤描述', null, function () {
                        alert(1);
                    }, null, null, true);
                    menu.addSeparator(null);
                    ...
                    menu.addItem('隐藏步骤', null, function () {
                        alert(1);
                    }, null, null, false);
                    menu.addItem('分离步骤', null, function () {
                        alert(1);
                    }, null, null, true);
                    menu.addSeparator(null);
                    ...
                    menu.addItem('预览', null, function () {
                        ...
                        Ext.Ajax.request({
                            ...
                            params: {
                                graphXml: me.toXml(),
                                selectedCells: encodeURIComponent(Ext.encode(selectedCells))
                            },
                            method: 'POST',
                            success: function (response) {
                                var jsonArray = Ext.decode(response.responseText);
                ...
                menu.addItem('编辑连接', null, function () {
                    alert(1);
                }, null, null, true);
                menu.addItem('使节点连接失效', null, function () {
                }, null, null, true);
                menu.addItem('删除节点连接', null, function () {
                    graph.removeCells();
                }, null, null, true);
                menu.addItem('翻转方向', null, function () {
                }, null, null, true);
            }
        }
    },
